...
// ** Icons Imports
// ** Data Imports
import Documents from 'src/pages/components/documents'
import ReraCertificates from 'src/pages/components/documents/rera-certificates'
import ReviewProfile from 'src/pages/components/documents/reviewProfile'
  ...
  return (
    <Fragment>
      {store?.loading ? (
        ...
        <Fragment>
          <StepperWrapper>
            <Stepper activeStep={maxVerifiedStep} alternativeLabel>
              {steps.map((step, index) => {
                return (
                  <Step key={index}>
                    <StepButton color='inherit' onClick={() => handleNext(index)} disableRipple>
